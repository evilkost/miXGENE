...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.dt_created'
        db.add_column(u'webapp_article', 'dt_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Article.dt_updated'
        db.add_column(u'webapp_article', 'dt_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 3, 13, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.dt_created'
        db.delete_column(u'webapp_article', 'dt_created')

        # Deleting field 'Article.dt_updated'
        db.delete_column(u'webapp_article', 'dt_updated')
