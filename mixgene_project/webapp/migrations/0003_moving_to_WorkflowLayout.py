...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WorkflowLayout.plan'
        db.delete_column(u'webapp_workflowlayout', 'plan')

        # Adding field 'WorkflowLayout.wfl_class'
        db.add_column(u'webapp_workflowlayout', 'wfl_class',
    ...
    def backwards(self, orm):
        # Adding field 'WorkflowLayout.plan'
        db.add_column(u'webapp_workflowlayout', 'plan',
                      self.gf('django.db.models.fields.TextField')(default=[]),
                      keep_default=False)

        # Deleting field 'WorkflowLayout.wfl_class'
        db.delete_column(u'webapp_workflowlayout', 'wfl_class')
