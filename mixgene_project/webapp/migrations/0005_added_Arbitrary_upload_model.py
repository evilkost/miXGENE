...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArbitraryUpload'
        db.create_table(u'webapp_arbitraryupload', (
        ...
        db.send_create_signal(u'webapp', ['ArbitraryUpload'])


    def backwards(self, orm):
        # Deleting model 'ArbitraryUpload'
        db.delete_table(u'webapp_arbitraryupload')
