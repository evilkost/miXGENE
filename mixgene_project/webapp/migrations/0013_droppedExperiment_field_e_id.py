...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Experiment.e_id'
        db.delete_column(u'webapp_experiment', 'e_id')

        # Adding field 'Experiment.id'
        db.add_column(u'webapp_experiment', u'id',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Experiment.e_id'
        raise RuntimeError("Cannot reverse this migration. 'Experiment.e_id' and its values cannot be restored.")
        # Deleting field 'Experiment.id'
        db.delete_column(u'webapp_experiment', u'id')
