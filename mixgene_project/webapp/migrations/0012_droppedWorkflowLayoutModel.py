...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'WorkflowLayout'
        db.delete_table(u'webapp_workflowlayout')

        # Deleting field 'Experiment.wfl_setup'
        db.delete_column(u'webapp_experiment', 'wfl_setup')

        # Deleting field 'Experiment.workflow'
        db.delete_column(u'webapp_experiment', 'workflow_id')


    def backwards(self, orm):
        # Adding model 'WorkflowLayout'
        db.create_table(u'webapp_workflowlayout', (
            ('w_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('wfl_class', self.gf('django.db.models.fields.TextField')(null=True)),
            ('description', self.gf('django.db.models.fields.TextField')(default='')),
            ('title', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal(u'webapp', ['WorkflowLayout'])

        # Adding field 'Experiment.wfl_setup'
        db.add_column(u'webapp_experiment', 'wfl_setup',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Experiment.workflow'
        raise RuntimeError("Cannot reverse this migration. 'Experiment.workflow' and its values cannot be restored.")
