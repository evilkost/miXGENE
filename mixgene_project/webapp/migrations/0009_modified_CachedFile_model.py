...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CachedFile.data'
        db.delete_column(u'webapp_cachedfile', 'data')

        # Deleting field 'CachedFile.filename_uuid'
        db.delete_column(u'webapp_cachedfile', 'filename_uuid')

        # Adding field 'CachedFile.uri_sha'
        db.add_column(u'webapp_cachedfile', 'uri_sha',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=127),
                      keep_default=False)

        # Adding field 'CachedFile.dt_updated'
        db.add_column(u'webapp_cachedfile', 'dt_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 10, 24, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CachedFile.data'
        db.add_column(u'webapp_cachedfile', 'data',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'CachedFile.filename_uuid'
        raise RuntimeError("Cannot reverse this migration. 'CachedFile.filename_uuid' and its values cannot be restored.")
        # Deleting field 'CachedFile.uri_sha'
        db.delete_column(u'webapp_cachedfile', 'uri_sha')

        # Deleting field 'CachedFile.dt_updated'
        db.delete_column(u'webapp_cachedfile', 'dt_updated')
