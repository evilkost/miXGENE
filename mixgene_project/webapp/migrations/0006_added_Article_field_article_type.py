...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'webapp_article', 'article_type',
                      self.gf('django.db.models.fields.CharField')(default='cs', max_length=31),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.article_type'
        db.delete_column(u'webapp_article', 'article_type')
