...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UploadedData.filename'
        db.add_column(u'webapp_uploadeddata', 'filename',
                      self.gf('django.db.models.fields.CharField')(default='default', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UploadedData.filename'
        db.delete_column(u'webapp_uploadeddata', 'filename')
