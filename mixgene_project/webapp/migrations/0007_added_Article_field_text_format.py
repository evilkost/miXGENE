...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.text_format'
        db.add_column(u'webapp_article', 'text_format',
                      self.gf('django.db.models.fields.CharField')(default='md', max_length=31),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.text_format'
        db.delete_column(u'webapp_article', 'text_format')
