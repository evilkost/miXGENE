...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkflowLayout.title'
        db.add_column(u'webapp_workflowlayout', 'title',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'WorkflowLayout.description'
        db.add_column(u'webapp_workflowlayout', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkflowLayout.title'
        db.delete_column(u'webapp_workflowlayout', 'title')

        # Deleting field 'WorkflowLayout.description'
        db.delete_column(u'webapp_workflowlayout', 'description')
