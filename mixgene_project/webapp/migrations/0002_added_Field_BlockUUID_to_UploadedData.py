...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UploadedData.block_uuid'
        db.add_column(u'webapp_uploadeddata', 'block_uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=127),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UploadedData.block_uuid'
        db.delete_column(u'webapp_uploadeddata', 'block_uuid')
