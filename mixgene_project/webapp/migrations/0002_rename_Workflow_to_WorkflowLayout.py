...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Experiment.workflow'
        db.alter_column(u'webapp_experiment', 'workflow_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webapp.WorkflowLayout']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Experiment.workflow'
        db.alter_column(u'webapp_experiment', 'workflow_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webapp.Workflow']))
